...
public final class GetResearchOutput
{
  ...
  private static final char FILLED_CIRCLE = '\u25CF';  // filled circle
  private static final char EMPTY_CIRCLE = '\u25CB';   // empty circle
  ...
  public static List<String> buildScorecard(Map<String, Integer> ratings)
  {
    ...
    lines.add("\u2502 RATING SCORECARD" + " ".repeat(innerWidth - 17) + "\u2502");
    lines.add("\u251C" + "\u2500".repeat(innerWidth) + "\u2524");
  ...
  public static List<String> buildConcernsBox(Map<String, List<String>> concerns)
  {
    ...
    lines.add("\u2502 🔍 Stakeholder Concerns" + " ".repeat(BOX_WIDTH - 25) + "\u2502");
    lines.add("\u251C" + "\u2500".repeat(BOX_WIDTH) + "\u2524");
    lines.add("\u2502" + " ".repeat(BOX_WIDTH) + "\u2502");
    ...
    for (String stakeholder : stakeholderOrder)
    {
      ...
      lines.add("\u2502 " + headerText + " ".repeat(BOX_WIDTH - headerText.length() - 1) + "\u2502");
      ...
      for (String concern : concernList)
      {
        ...
        String bulletText = "  • " + truncated;
        lines.add("\u2502 " + bulletText + " ".repeat(BOX_WIDTH - bulletText.length() - 1) + "\u2502");
        ++count;
      }
      lines.add("\u2502" + " ".repeat(BOX_WIDTH) + "\u2502");
    }
  ...
  public static List<String> buildOptionsBoxHeader()
  {
    return List.of(
      "\u256D" + "\u2500".repeat(BOX_WIDTH) + "\u256E",
      "\u2502 📋 Recommended Approaches" + " ".repeat(BOX_WIDTH - 27) + "\u2502",
      "\u251C" + "\u2500".repeat(BOX_WIDTH) + "\u2524",
      "\u2502" + " ".repeat(BOX_WIDTH) + "\u2502"
    );
  }
