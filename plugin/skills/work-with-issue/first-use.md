...
Execute all work phases (execute, verify, review, merge) with the main agent directly orchestrating each phase.
...
- Verify: Invoke verify-implementation skill
...
Progress banners for all 5 phases are generated by the work_with_issue_handler and provided
...
**This step verifies PLAN.md acceptance criteria were implemented before stakeholder quality review.**

**Output the Verifying banner** from INDIVIDUAL PHASE BANNERS (`● ● ◉ ○ ○` pattern).
