...
/**
 * Interface for Edit tool handlers.
 * <p>
 * Edit handlers validate edit operations before they are executed.
 * PreToolUse handlers can block edits or inject warnings.
 * <p>
 * Result factory methods: EditHandler uses warn() to emit stderr warnings
...
{
  /**
   * The result of an edit handler check.
   *
  ...
  {
    /**
     * Creates a new edit handler result.
     *
