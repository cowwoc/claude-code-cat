...
1. Base repository: https://github.com/cowwoc/claude-code-cat
2. https://github.com/glittercowboy/get-shit-done
...
**MAJOR → MINOR → TASK** (replaces GSD's MILESTONE → PHASE → PLAN)
