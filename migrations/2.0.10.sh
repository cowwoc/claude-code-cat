...
# Migration to CAT 2.0.10
#
# Changes:
# - Removes yoloMode in favor of trust: high
# - yoloMode: true -> trust: high (full autonomy, skip reviews)
# - yoloMode: false -> no change (trust already set by 2.0.9 migration)
#
# This completes the configuration consolidation started in 2.0.9.
# All autonomy/review behavior is now controlled by the single "trust" setting.

# Error handler
trap 'echo "ERROR in 2.0.10.sh at line $LINENO: $BASH_COMMAND" >&2; exit 1' ERR
...
backup_cat_dir "pre-2.0.10-migration"
