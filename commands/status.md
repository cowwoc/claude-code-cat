...
**CRITICAL**: Use ZWSP lines (U+200B) before deeply-indented content to preserve bold rendering.
Lines that appear blank below contain a single zero-width space character.
