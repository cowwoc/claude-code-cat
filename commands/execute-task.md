...
LOCK_RESULT=$("/home/node/.config/claude/plugins/cache/claude-code-cat/cat/2.0.2/scripts/task-lock.sh" acquire "$TASK_ID" "$SESSION_ID")
...
```bash
"/home/node/.config/claude/plugins/cache/claude-code-cat/cat/2.0.2/scripts/task-lock.sh" heartbeat "$TASK_ID" "$SESSION_ID"
```
...
TASK_ID="${MAJOR}.${MINOR}-${TASK_NAME}"
"/home/node/.config/claude/plugins/cache/claude-code-cat/cat/2.0.2/scripts/task-lock.sh" release "$TASK_ID" "$SESSION_ID"
